...
The relevant data for the project can be found ([10.5281/zenodo.18190120](https://doi.org/10.5281/zenodo.18190120)). This contains the processed experimental data for mutual information calculation. It also contains results from the minimal model exploration, particularly the optimized strategies, as almost all of the calculations were performed on the MIT Engaging cluster -- the saved data means you don't need to repeat this computation.
