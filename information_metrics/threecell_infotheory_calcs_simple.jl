#This is for calculation of informatin metrics of the three cell system (1,2,3) between cells 1 and 2
...
include("../three_cell_coarsegraining/three_cell_coarse_graining_simple.jl")
