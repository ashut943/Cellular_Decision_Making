...
num_timesteps = 2 # Number of timesteps for the information metrics, i.e number of queries. Here, we choose 2 as we only want to know the final values of these metrics
