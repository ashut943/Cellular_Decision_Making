...
include("../information_metrics/infotheoryfuncs_three_cells_simple.jl")
...
plots_folder="./plots/three_cell_results/"*type_of_boundary_str*"/"*"N_$(N)_lambda_$(lambda_str)"*"_"*type_of_optimisation_1*"/"*string(num_simulations)*"_simple/"
mkpath(plots_folder)
#--------------------------------
...
threecell_system = CellularDecisions_final.load(threecell_system_filename)
plots_folder="./plots/three_cell_results/"*type_of_boundary_str*"/"*"N_$(N)_lambda_$(lambda_str)"*"_"*type_of_optimisation_2*"/"*string(num_simulations)*"_simple/"
mkpath(plots_folder)
#--------------------------------
# Get state matrices, sizes, and target states
statedict=threecell_system.state_dict
...
combined_plot_dir = "./plots/three_cell_results/boundary_comparison/"*type_of_optimisation_1*"_vs_"*type_of_optimisation_2*"_w_"*type_of_boundary_condition*"/"*"N_$(N)_lambda_$(lambda_str)"*"/"*string(num_simulations)*"_simple/"
